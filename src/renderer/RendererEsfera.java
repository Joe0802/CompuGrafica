...
public class RendererEsfera implements GLEventListener,MouseListener, MouseMotionListener{
    ...
    public void display(GLAutoDrawable drawable) {
       if (fin[0] && fin[1] && fin[2] && fin[3]){
            if(
            color[NroJugada][0][0]==TexturaIU.Solucion[0][0] &&
            color[NroJugada][0][1]==TexturaIU.Solucion[0][1] &&
            color[NroJugada][0][2]==TexturaIU.Solucion[0][2] &&
            color[NroJugada][1][0]==TexturaIU.Solucion[1][0] &&
            color[NroJugada][1][1]==TexturaIU.Solucion[1][1] &&
            color[NroJugada][1][2]==TexturaIU.Solucion[1][2] &&
            color[NroJugada][2][0]==TexturaIU.Solucion[2][0] &&
            color[NroJugada][2][1]==TexturaIU.Solucion[2][1] &&
            color[NroJugada][2][2]==TexturaIU.Solucion[2][2] &&
            color[NroJugada][3][0]==TexturaIU.Solucion[3][0] &&
            color[NroJugada][3][1]==TexturaIU.Solucion[3][1] &&
            color[NroJugada][3][2]==TexturaIU.Solucion[3][2] ){
